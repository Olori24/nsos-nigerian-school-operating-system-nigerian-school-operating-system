...
export default function PublicAdmissions() {
  ...
  const [form, setForm] = useState({ firstName: "", lastName: "", guardianName: "", guardianPhone: "", guardianEmail: "", notes: "" });
  const [supplementalData, setSupplementalData] = useState<Record<string, string>>({});
  ...
  const template = school.data.admissionTemplate ?? fallbackTemplate;
