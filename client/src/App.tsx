    ...
    <ErrorBoundary>
      <ThemeProvider defaultTheme="light" switchable>
        <TooltipProvider>
          ...
          <InstallNSOSPrompt />
          <NSOSUpdatePrompt />
          <div className="fixed bottom-[max(1rem,env(safe-area-inset-bottom))] right-[max(1rem,env(safe-area-inset-right))] z-50 sm:bottom-5 sm:right-5 sm:z-[70]">
            <BiodataThemeToggle />
          </div>
        </TooltipProvider>
      </ThemeProvider>
