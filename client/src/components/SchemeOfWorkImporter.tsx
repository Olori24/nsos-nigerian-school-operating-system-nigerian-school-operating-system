...
import { AlertTriangle, FileSpreadsheet, LockKeyhole, Replace, Upload, X } from "lucide-react";
...
export function SchemeOfWorkImporter({ schoolId, academic, canConfigure, onDone }: { schoolId: number; academic: any; canConfigure: boolean; onDone: () => void }) {
