...
**Overall verdict:** **BLOCKED for public paid launch.** The platform can prepare and review a private academy foundation through authenticated owner/admin workflows, and its managed outbound sender is now verified for provider submission. A real public academy launch still requires owner-reviewed public content, merchant/payment evidence, certificate design, staging/recovery, and measured-capacity evidence.
...
| Email and transactional support | **PASS — managed outbound provider submission** | `notifications@nsos.top` has verified Resend outbound-sending records. One owner-authorized controlled staff invitation was accepted by the provider; protected no-send invitation and record-email tests pass. | Do not claim inbox delivery, replies, bounces, opens, bulk delivery, or school-specific sender capability without separately approved transport evidence. |
