...
export function InlineFieldFeedback({ validation }: { validation?: InlineValidation }) {
  ...
  if (validation.state === "valid") return <span className="inline-flex items-center gap-1 text-[#277543]" role="status"><CheckCircle2 aria-hidden="true" className="h-3.5 w-3.5" /><span className="sr-only">Looks good</span></span>;
