...
const autoFill = readFileSync(
  resolve(projectRoot, "client/src/components/BiodataDocumentAutofill.tsx"),
  "utf8"
);
const aiCue = readFileSync(
  resolve(projectRoot, "client/src/components/AiAppliedFieldCue.tsx"),
  "utf8"
);
