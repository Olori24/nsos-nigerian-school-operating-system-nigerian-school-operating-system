...
- [ ] Add builder-first UX, template, AI-output, tenant-isolation, approval-boundary, versioning, quality-readiness, copilot, and mobile regressions; validate, document the phased rollout, checkpoint, publish, and synchronize GitHub safely.
