...
- [x] Add a persistent accessible dark-mode toggle to dashboard settings, validate contrast and responsive behavior, publish, and synchronize GitHub.
- [ ] Build the approval-first File-to-School AI Engine: private knowledge-library sources, source-traceable curriculum/quality/gap drafts, owner-controlled improvement recommendations, protected Course Studio/Builder handoffs, safety regressions, documentation, publication, and GitHub synchronization.
