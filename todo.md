...
- [ ] Prepare an isolated NSOS staging handoff with synthetic-only data, provider stubs, recovery authority, and restricted test access; do not provision or run it until owner/infrastructure evidence is approved.
