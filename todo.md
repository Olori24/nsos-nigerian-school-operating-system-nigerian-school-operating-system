...
- [ ] Prepare and, after explicit confirmation, submit a redacted Resend support inquiry for the `nsos.top` `partially_failed` inconsistency; do not change sender, DNS, mailbox, provider configuration, or send email.
- [ ] Obtain a Resend support case or provider response through a distinct supported channel after the public form returned a generic processing error; do not blindly repeat the failed form submission or change any email configuration.
